...
class MostStarredDefinitions extends React.Component {
  ...
  getDefinitions = () => {
    ...
    fetch(process.env.API_URL + 'api/mostStarredDefinitions', {
    ...
    return (
      <div>
        <Typography variant="h5" className={classes.center}>
          Report Definitions Starred<br />by the Most Users
        </Typography>
            ...
            {definitions.map(definition => {
              return (
                <TableRow hover key={definition._id}>
                  ...
                  <TableCell numeric>{definition.starred}</TableCell>
                </TableRow>
              );
            })}
          </TableBody>
...
MostStarredDefinitions.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(MostStarredDefinitions);
