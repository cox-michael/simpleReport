...
class MostSubscribedToDefinitions extends React.Component {
  ...
  getDefinitions = () => {
    ...
    fetch(process.env.API_URL + 'api/mostSubscribedToDefinitions', {
    ...
    return (
      <div>
        <Typography variant="h5" className={classes.center}>
          Report Definitions with the<br />Most Users Subscribed
        </Typography>
        ...
        <Table className={classes.table}>
          <TableHead>
            <TableRow>
              ...
              <TableCell numeric>Subscriptions</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {definitions.map(definition => {
              return (
                <TableRow hover key={definition._id}>
                  ...
                  <TableCell numeric>{definition.subscriptions}</TableCell>
                </TableRow>
              );
            })}
          </TableBody>
...
MostSubscribedToDefinitions.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(MostSubscribedToDefinitions);
